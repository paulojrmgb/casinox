...
/* CASINOX v3.7 — GAME ENGINE IMERSIVO / OFFLINE DEMO */
(function(){
  const games={
...
/* CASINOX v3.7 — engine visual próprio. O sistema de toque da v3.7 permanece intacto. */
(function(){
  const symbols=["🐰","🪙","💎","🧧","👑","🥕","🔔","🟡","🌸","💰"];
  ...
  function open(name){
    ...
    shell.innerHTML=`
      <header class="cx20-top">
        ...
        <span class="cx34-version">v3.7</span>
...
/* CASINOX v3.7 PATCH — mobile stability */
(function(){
...
/* =========================================================
   CASINOX v3.7 — SINGLE GAME ENTRY / FIX BACK
...
/* =========================================================
   CASINOX v3.7 — AUTHORITATIVE MOBILE CONTROLS
...
/* v3.7 portal badge — single authoritative version */
(function(){
  function add(){
