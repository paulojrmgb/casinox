...
/* CASINOX v4.1 — GAME ENGINE IMERSIVO / OFFLINE DEMO */
(function(){
  const games={
...
/* CASINOX v4.1 — engine visual próprio. O sistema de toque da v4.1 permanece intacto. */
(function(){
  const symbols=["🐰","🪙","💎","🧧","👑","🥕","🔔","🟡","🌸","💰"];
  ...
  function open(name){
    ...
    shell.innerHTML=`
      <header class="cx20-top">
        ...
        <span class="cx34-version">v4.1</span>
...
/* CASINOX v4.1 PATCH — mobile stability */
(function(){
...
/* =========================================================
   CASINOX v4.1 — SINGLE GAME ENTRY / FIX BACK
...
/* =========================================================
   CASINOX v4.1 — AUTHORITATIVE MOBILE CONTROLS
...
/* v4.1 portal badge — single authoritative version */
(function(){
  function add(){
